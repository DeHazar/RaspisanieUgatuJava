...
import hazarsoftware.raspisanieugatu.NotesPart.notedetail.NoteDetailActivity;
...
public class NotesFragment extends Fragment implements NotesContract.View{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mActionsListener = new NotesPresenter(UserSettings.provideNotesRepository(), this);
    }
